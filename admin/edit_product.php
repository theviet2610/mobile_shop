	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active"><?php echo $row_prd["cat_name"]; ?></li>
			</ol>
		</div><!--/.row-->
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <br>
                                    <div>
                                        <img width="160" height="210" src="img/product/<?php echo $row_prd["prd_image"] ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select name="cat_id" class="form-control">
                                        ...
                                        ?>
                                        <option <?php if($row_prd["cat_id"]==$row_cat["cat_id"]){ echo "selected";} ?> value=1><?php echo $row_cat["cat_name"]; ?></option>
                                ...
                                <div class="form-group">
                                        ...
                                        <textarea name="prd_details" id="prd_details" required class="form-control" rows="3"><?php echo $row_prd["prd_details"]; ?></textarea>
                                        <script >
