        	...
        	<div id="main" class="col-lg-8 col-md-12 col-sm-12">
                ...
                if(isset($_GET["page_layout"])){
                    switch ($_GET["page_layout"]) {
                        case 'cart': include_one("cart.php") break;
                        case 'category': include_one("category.php") break;
                        case 'product': include_one("product.php") break;
                        case 'success': include_one("success.php") break;
                    }
                }
                ?>
